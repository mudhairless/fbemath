...
operator * ( byref lhs as Vector2F, byref rhs as matrixF ) as Vector2F
    ...
    return type<Vector2F>( lhs.x*rhsdata[0] + lhs.y*rhsdata[4] + rhsdata[12], _
...
operator * ( byref lhs as Vector3F, byref rhs as matrixF ) as Vector3F
    var rhsdata = rhs.getarraydata
    return type<Vector3F>( lhs.x*rhsdata[0] + lhs.y*rhsdata[4] + lhs.z*rhsdata[8]  + rhsdata[12], _
...
operator * ( byref lhs as Vector4F, byref rhs as matrixF ) as Vector4F
    var rhsdata = rhs.getarraydata
    return type<Vector4F>( lhs.x*rhsdata[0] + lhs.y*rhsdata[4] + lhs.z*rhsdata[8]  + rhsdata[12], _
    lhs.x*rhsdata[1] + lhs.Y*rhsdata[5] + lhs.Z*rhsdata[9]  + rhsdata[13], _
